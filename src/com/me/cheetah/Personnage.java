...
public class Personnage {
		float coordonneeX=Gdx.graphics.getWidth()/2 ;
		float coordonneeY=0;
		float hauteur;
		float largeur;
		Texture image;
	    ...
	    private float duree_animation = 0.4f;
	...
	//------------------------------------------           
		...
		public void dessiner(SpriteBatch batch){
			...
			duree_animation=duree_animation-0.1f;
		...
		public void descendre(float deplacement){
			coordonneeY-=deplacement;
		}
}
